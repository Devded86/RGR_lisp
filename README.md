...
### Висновок
Правильність роботи програми підтверджено шляхом порівняння результатів з альтернативними розрахунками, виконаними у середовищі MATLAB. Значення, отримані обома методами, повністю збігаються, що свідчить про коректність реалізованого алгоритму. Тестування показало, що на проміжку $i=2\dots5$ функція набуває сталого значення $5.0$, а на проміжку $i=7\dots20$ монотонно зростає, що відповідає математичній природі заданої формули.
